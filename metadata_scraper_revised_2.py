...
def list_directories(base_path):
    ...
    for filename in key_list:
        ...
        with VideoFileClip(os.path.join(base_path, f"{filename}_F.mp4")) as clip_f:
            ...
            lon_deg1_0 = clip_f.crop(x1=280,y1=1375,x2=310,y2=1410)
            lon_deg1_1 = clip_f.crop(x1=310,y1=1375,x2=340,y2=1410)
            
            lon_deg2_0 = clip_f.crop(x1=360,y1=1375,x2=390,y2=1410)
            lon_deg2_1 = clip_f.crop(x1=387,y1=1375,x2=415,y2=1410)
            lon_deg2_2 = clip_f.crop(x1=414,y1=1375,x2=443,y2=1410)
            lon_deg2_3 = clip_f.crop(x1=442,y1=1375,x2=470,y2=1410)

            lat = clip_f.crop(x1=488,y1=1370,x2=758,y2=1420)
            lat_heading = clip_f.crop(x1=490,y1=1375,x2=525,y2=1410)
            lat_deg1_0 = clip_f.crop(x1=540,y1=1375,x2=570,y2=1410)
            lat_deg1_1 = clip_f.crop(x1=570,y1=1375,x2=600,y2=1410)
            lat_deg2_0 = clip_f.crop(x1=615,y1=1375,x2=645,y2=1410)
            lat_deg2_1 = clip_f.crop(x1=647,y1=1375,x2=675,y2=1415)
            lat_deg2_2 = clip_f.crop(x1=670,y1=1375,x2=700,y2=1410)
            lat_deg2_3 = clip_f.crop(x1=700,y1=1375,x2=730,y2=1410)
            ...
            for x in range(int(duration)):
                ...
                lon_deg1_0.save_frame('lon_deg1_0_heading.png', x)
                lon_deg1_1.save_frame('lon_deg1_1_heading.png', x)

                lon_deg1_out = reader.readtext('lon_deg1_heading.png', detail = 0)
                lon_deg2_0.save_frame('lon_deg2_0_heading.png', x)
                lon_deg2_1.save_frame('lon_deg2_1_heading.png', x)
                lon_deg2_2.save_frame('lon_deg2_2_heading.png', x)
                lon_deg2_3.save_frame('lon_deg2_3_heading.png', x)
                ...
                lat_deg1_0.save_frame('lat_deg1_0_heading.png', x)
                lat_deg1_1.save_frame('lat_deg1_1_heading.png', x)
                lat_deg1_out = reader.readtext('lat_deg1_heading.png', detail = 0)
                # lat_deg2.save_frame('lat_deg2_heading.png', x)
                lat_deg2_0.save_frame('lat_deg2_0_heading.png', x)
                lat_deg2_1.save_frame('lat_deg2_1_heading.png', x)
                lat_deg2_2.save_frame('lat_deg2_2_heading.png', x)
                lat_deg2_3.save_frame('lat_deg2_3_heading.png', x)
                all = reader.readtext('lat_deg2_heading.png')
                a = reader.readtext('lat_deg2_0_heading.png')
                b = reader.readtext('lat_deg2_1_heading.png')
                c = reader.readtext('lat_deg2_2_heading.png')
                d = reader.readtext('lat_deg2_3_heading.png')
                print(all, a,b,c,d)
                if (len(all) == 0 | len(a) == 0 | len(b) == 0 | len(c) == 0 | len(d) == 0):
                    print(all, a,b,c,d)
                
                elif str(all[0][1]) == f"{a[0][1]}{b[0][1]}{c[0][1]}{d[0][1]}":
                    print("yes")
                else:
                    print(all[0][1], f"{a[0][1]}{b[0][1]}{c[0][1]}{d[0][1]}")
