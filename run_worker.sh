...
export NEO4J_PASSWORD="${NEO4J_PASSWORD:-$(python3 -c "from auto_ingest_config import get_neo4j_password; print(get_neo4j_password())" 2>/dev/null || echo "${NEO4J_PASSWORD_DEFAULT:-knowledge_graph_2026}")}"
